...
def test_python_tool() -> None:
    python_executor = ToolRegistry.registry["python_interpreter"][
        "real_python_interpreter_execute"
    ]
    ...
    result = python_executor.call(
        PythonInterpreterInput(script="print('Hello, World!')")
    )
